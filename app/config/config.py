...
# ============================================================================
# 🎯 Environment Variables — .env File Load
# ============================================================================
try:
...
# ============================================================================
# 🎯 Environment Variable Override — .env က — Priority မြင့်
# ============================================================================
def _apply_env_overrides(config_dict: dict) -> dict:
    """Override config values with .env variables if set

    .env file မှာ တန်ဖိုး ရှိရင် — config.toml ကို — Override လုပ်မယ်။
    .env မှာ မရှိရင် — config.toml Value — ဆက် သုံးမယ်။
    """
    env_mapping = {
