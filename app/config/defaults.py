...
def normalize_openai_compatible_model_name(
    ...
    """Keep the full model name exactly as entered by the user.

    Do not strip the provider prefix here, because some OpenAI-compatible
    providers (such as Groq) include the prefix as part of the real model ID.
    """
