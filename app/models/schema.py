...
class VideoClipParams(BaseModel):
    ...
    # ========================================================================
    # Advanced Features (Anti-Virus Studio)
    # ========================================================================
    advanced_params: Optional[dict] = Field(
        default_factory=dict,
        description="Advanced feature settings (Watermark, Logo, Cinematic, AI, Blur, Adjustments)",
    )
